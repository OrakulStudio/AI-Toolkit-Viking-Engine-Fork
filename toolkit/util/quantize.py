...
torchao_qtypes = {
    ...
    # [ORACLE-60] Нативный FP8 для Ada (4090)
    # [ORACLE-60] Чистый конфиг без лишних аргументов
    ...
    for name, m in model.named_modules():
        ...
        try:
            ...
            if isinstance(weights, aotype):
                # [ORACLE-60] Квантуем на CPU, чтобы не фрагментировать VRAM на больших рангах
...
def quantize_model(base_model: "BaseModel", model_to_quantize: torch.nn.Module):
    ...
    if q_name == 'bf8' and isinstance(quantization_type, aotype):
        ...
        base_model.print_and_status_update(">>> [ORACLE-60] BF8 NATIVE (E5M2) DETECTED - CPU PRE-QUANT MODE")
    ...
    for block in tqdm(all_blocks, desc="Quantizing Flux"):
